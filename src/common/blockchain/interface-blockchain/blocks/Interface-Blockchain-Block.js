...
class InterfaceBlockchainBlock {
    ...
    serializeBlock(requestHeader){
        ...
        if (!requestHeader && this.computedSerialization !== undefined ) return this.computedSerialization;
        ...
        if ( !requestHeader && this.computedSerialization === undefined ) this.computedSerialization = data;
